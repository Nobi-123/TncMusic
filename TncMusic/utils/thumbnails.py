...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("TNCxMUSIC/assets/font2.ttf", 30)
        font = ImageFont.truetype("TNCxMUSIC/assets/font.ttf", 30)
        title_font = ImageFont.truetype("TNCxMUSIC/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("TNCxMUSIC/assets/play_icons.png")
